...
struct Kinect2Calibration
{
    ...
    Eigen::Matrix4f extr_transformation;
    ...
    bool loadExtrinsicCalibration(const std::string &path)
    {
        ...
        extr_transformation = Eigen::Matrix4f::Identity();
        extr_transformation(0,0) = extr_rotation_matrix.at<double>(0,0);
        extr_transformation(0,1) = extr_rotation_matrix.at<double>(0,1);
        extr_transformation(0,2) = extr_rotation_matrix.at<double>(0,2);
        extr_transformation(1,0) = extr_rotation_matrix.at<double>(1,0);
        extr_transformation(1,1) = extr_rotation_matrix.at<double>(1,1);
        extr_transformation(1,2) = extr_rotation_matrix.at<double>(1,2);
        extr_transformation(2,0) = extr_rotation_matrix.at<double>(2,0);
        extr_transformation(2,1) = extr_rotation_matrix.at<double>(2,1);
        extr_transformation(2,2) = extr_rotation_matrix.at<double>(2,2);
        extr_transformation(0,3) = extr_translation_matrix.at<double>(0);
        extr_transformation(1,3) = extr_translation_matrix.at<double>(1);
        extr_transformation(2,3) = extr_translation_matrix.at<double>(2);
        extr_transformation = extr_transformation.inverse().eval();
        return true;
    }
